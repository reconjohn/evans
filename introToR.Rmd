...
# default metric is Euclidean, gower deals with ordinal variance. 
```
...
# sil_width? how good the observation is included well in the cluster(negative is saying those in that cluster should not be in that cluster).
...
# https://github.com/reconjohn/evans/raw/master/world_map.json
